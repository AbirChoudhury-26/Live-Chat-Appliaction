...
const Home = () => {
  const [RoomCode, setRoomCode] = useState(''); // This hook state is uset to set the value to given class like here for RoomCode
      ...
      <div className="relative h-screen">
        ...
        <div className=" lg:flex flex-col justify-center relative z-10 px-10 py-8 md:max-w-[90vw]">
          <div className="lg:flex flex-col  justify-center pb-10 mb-10">
            <h1 className="text-[66px] md:text[80px] text-white"> Video Chat App</h1>
            <p className="text-[25px] -mt-2 text-white"> A perfect <b className='custom-yellow'>ONLINE CHAT</b> Application</p>
          </div>
